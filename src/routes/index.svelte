...
<html lang="en">
			...
			<div class="lg:flex lg:items-center px-4 pt-9 max-w-lg md:max-w-xl lg:max-w-4xl mx-auto">
				<div class="lg:pt-16 pb-32">
					...
					<p class="pt-6 text-sm text-gray-600 leading-loose">
						...
						nobis dolor libero eveniet neque laudantium nihil eius asperiores sequi quia harum
						aliquid autem doloribus, aperiam nostrum non.
					</p>
					<a
						href="#"
	...
	<footer class="footer bg-yellow-300 relative pt-1 border-b-2 border-blue-700">
		<div class="container mx-auto px-6">
			<div class="sm:flex sm:mt-8">
				<div class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
					<div class="flex flex-col">
						<span class="font-bold text-gray-700 uppercase mb-2">Adresse</span>
						<span class="text-gray-700 text-sm">Privater Automarkt</span>
						<span class="text-gray-700 text-sm">Manfred Schlett</span>
						<span class="text-gray-700 text-sm">Herrenlandstrasse 39</span>
						<span class="text-gray-700 text-sm">78315 Radolfzell</span>
						<span><a href="#" class=" hover:text-gray-800">+49 7732 94 24 08</a></span>
						<span
							><a href="#" class="text-gray-700  text-sm hover:text-gray-800">info@billig-car.de</a
							></span
						>
					</div>
					<div class="flex flex-col">
						<span class="font-bold text-gray-700 uppercase mt-4 md:mt-0 mb-2">Öffnungszeiten:</span>
						<span class="my-2">Montag bis Freitag: 10:00 bis 18:00</span>
						<span class="my-2">Samstag: 10:00 bis 14:00</span>
					</div>
				</div>
			</div>
		</div>
		<div class="container mx-auto px-6">
			<div class="mt-16 border-t-2 border-gray-300 flex flex-col items-center">
				<div class="sm:w-2/3 text-center py-6">
					<p class="text-sm text-gray-400 font-extralight mb-1">
						© 2022 Privater Automarkt Radolfzell
					</p>
				</div>
			</div>
		</div>
